    ...
    For Each CurrentWs In Worksheets
        ...
        For i = 2 To Lastrow
            ...
            If CurrentWs.Cells(i + 1, 1).Value <> CurrentWs.Cells(i, 1).Value Then
                ...
                Delta_Price = 0
                ' Challenge Section,do this in the beginning of the for loop Delta_Percent = 0
                Close_Price = 0
                ' Capture next Ticker's Open_Price
                Open_Price = CurrentWs.Cells(i + 1, 3).Value
              
                
                ' Challenge Section : Populate new Summary table on the right for the current spreadsheet HERE
                ...
                ' Challenge Section adjustments to resetting counters
                Delta_Percent = 0
                Total_Ticker_Volume = 0
